...
class MX_GENMSL_API MslShaderGenerator : public HwShaderGenerator
{
  ...
  protected:
    ...
    enum QueryType { ALL_VARIABLE_LIST, ONLY_VARIABLE_DECL, VARIABLE_DECL_STRUCT };
    ...
    void emitInputs(GenContext& context, ShaderStage& stage,
                    const VariableBlock& inputs,
                    QueryType qeury) const;
    
    void emitUniforms(GenContext& context, ShaderStage& stage,
